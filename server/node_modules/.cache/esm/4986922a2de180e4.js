let mongoose,bcrypt;_2de‍.x([["default",()=>_2de‍.o]]);_2de‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_2de‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);
...
userSchema.pre('save',function(next) {
    ...
    if(user.isModified('password')){
        ...
        return bcrypt.hash(user.password,12,function(err,hash) {
            if(err){
                _2de‍.g.console.log("BCRYPT HAS ERROR", err);
                return next(err);
            }
            user.password=hash;
            return next();
...
_2de‍.d(mongoose.model('User',userSchema));